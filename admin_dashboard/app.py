...
def dashboard():
    ...
    return render_template('index.html',eventdetails=eventdetails,namedetails=namedetails,plandetails=plandetails,webdetails=webdetails,timeline=timeline,timeline2=timeline2)
